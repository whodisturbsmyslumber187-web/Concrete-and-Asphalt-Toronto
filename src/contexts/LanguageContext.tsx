...
export const translations: Translations = {
  ...
  "project1.title": { en: "Luxury Estate Driveway", fr: "Entrée de domaine de luxe" },
  "project1.desc": { en: "Expansive stamped concrete driveway with exposed aggregate borders and integrated drainage. A stunning entrance for a lakefront estate property.", fr: "Entrée en béton estampé avec bordures d'agrégat exposé et drainage intégré. Une entrée magnifique pour un domaine au bord du lac." },
  "project2.title": { en: "Corporate Plaza Parking", fr: "Stationnement de plaza corporatif" },
  ...
  "project3.title": { en: "Municipal Sidewalk Replacement", fr: "Remplacement de trottoirs municipaux" },
  ...
  "project4.title": { en: "Backyard Patio & Walkway", fr: "Patio arrière et allée" },
  ...
  "project5.title": { en: "Industrial Warehouse Floor", fr: "Plancher d'entrepôt industriel" },
  ...
  "project6.title": { en: "Townhome Development Paving", fr: "Pavage de complexe résidentiel" },
  ...
  "project7.title": { en: "Heritage Home Restoration", fr: "Restauration de maison patrimoniale" },
  "project7.desc": { en: "Historically sympathetic interlocking stone and concrete driveway restoration preserving the character of a 1920s home while meeting modern drainage requirements.", fr: "Restauration d'entrée en pierre imbriquée et béton respectant le caractère d'une maison des années 1920 tout en répondant aux exigences modernes de drainage." },
  "project8.title": { en: "Custom Home Concrete Package", fr: "Ensemble béton pour maison sur mesure" },
  "project8.desc": { en: "Complete concrete package: exposed aggregate driveway, stamped concrete pool deck, rear patio with retaining walls, and decorative walkways.", fr: "Ensemble complet en béton : entrée en agrégat exposé, contour de piscine estampé, patio arrière avec murs de soutènement et allées décoratives." },
  "project9.title": { en: "Luxury Estate Circular Drive", fr: "Entrée circulaire de domaine" },
  ...
  "project10.title": { en: "Commercial Strip Mall Repave", fr: "Repavage de centre commercial" },
  ...
  "project11.title": { en: "Modern Build Driveway", fr: "Entrée de construction moderne" },
  "project11.desc": { en: "Contemporary broom-finish driveway and outdoor concrete work for a modern custom build. Clean lines, precise grading, and seamless curb transitions.", fr: "Entrée finie au balai et travaux de béton extérieur pour une construction sur mesure moderne. Lignes épurées, nivellement précis et transitions de bordure." },
  "project12.title": { en: "Cottage Property Pathways", fr: "Sentiers de propriété de chalet" },
